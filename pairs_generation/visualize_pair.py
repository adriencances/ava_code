...
class Printer:
    def __init__(self):
        ...
        self.output_dir = "/home/acances/Data/Ava_v2.2/pairs_images"
    ...
    def print_pair(self, pairs_file, line_nb):
        ...
        for i in range(tensor1.shape[1]):
            filename1 = "{}/tensor1_frame_{}.jpg".format(self.output_dir, i + 1)
            frame1 = tensor1[:,i,:,:].numpy().transpose(2, 1, 0)
            cv2.imwrite(filename1, frame1)

            filename2 = "{}/tensor2_frame_{}.jpg".format(self.output_dir, i + 1)
...
if __name__ == "__main__":
    ...
    printer.print_pair(pairs_file, line_nb)
