...
def is_positive_pair(tr1, tr2):
    ...
    if temporal_intersection < min_temporal_intersection:
        return False
...
def find_positive_pairs_for_shot(file):
    ...
    for i in range(nb_tracks):
        ...
        for j in range(i + 1, nb_tracks):
            ...
            if is_positive_pair(tr1, tr2):
                nb_positive_pairs += 1
                # print(i, j)
    print("{}/{}".format(nb_positive_pairs, nb_pairs))


def find_positive_pairs_for_video(video_id, cat):
    tracks_files = glob.glob("{}/{}/{}/*".format(tracks_dir, cat, video_id))
    for tracks_file in tracks_files:
        find_positive_pairs_for_shot(tracks_file)
        break
...
if __name__ == "__main__":
    ...
    for video_folder in video_folders:
        ...
        find_positive_pairs_for_video(video_id, cat)
        break
